...
ActiveRecord::Schema[7.0].define(version: 2023_04_10_152206) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.check_constraint "restaurant_rating >= 1 AND restaurant_rating <= 5", name: "check_restaurant_rating_range"
  end
  ...
  create_table "product_orders", force: :cascade do |t|
    ...
    t.check_constraint "product_quantity >= 0", name: "check_product_quantity_non_negative"
    t.check_constraint "product_unit_cost >= 0", name: "check_product_unit_cost_non_negative"
  end
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "cost >= 0", name: "check_cost_greater_than_zero"
  end
  ...
  create_table "restaurants", force: :cascade do |t|
    ...
    t.check_constraint "price_range >= 1 AND price_range <= 3", name: "check_price_range"
  end
